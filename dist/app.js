...
const getFormData = ($form) => {
    ...
    const indexed_array = {};
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.map(unindexed_array, (n, i) => {
...
const loadToForm = (data) => {
  for (const key in data) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(`input[name=${key}]`).val(data[key]);
  }
}
...
*/
const $form = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#editor-form');
const $bookslist = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#list');
const $removeModal = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.delete-modal');
const $rmRemove = $removeModal.find('.remove');
const $rmCancel = $removeModal.find('.cancel');
const $sortRadios = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('input[name=sorting]');
const $searchForm = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#search-form');
const $searchInput = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#search-input');
...
*/
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('body').on('click','.remove-button a', event => {
  bookToDelete = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(event.currentTarget).data('index');
  $removeModal.show();
})
...
*/
__WEBPACK_IMPORTED_MODULE_1_jquery___default()('body').on('click','.buttons a', event => {
  const index = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(event.currentTarget).data('index');
...
$searchForm.on('submit', event => {
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.each(booksToSearch, function() {
    if (__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).find('.name').text().toLowerCase().indexOf(phraseToSearch) === -1) {
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).hide();
    } else {
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).show();
    }
  });
});
